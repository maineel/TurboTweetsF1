...
function Navbar() {
  return (
    <nav className="w-full bg-black text-red-500 h-auto flex justify-between px-4 py-4 md:px-4 items-center">
      ...
      <div class="hidden md:block px-1 py-1 cursor-pointer bg-white text-red-500 font-bold rounded hover:bg-red-500 hover:text-black">
        Login | Signup
      </div>
