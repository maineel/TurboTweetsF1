...
function Accounts({ accounts }) {
  const imageUrl =
    accounts.community_icon ||
    "https://b.thumbs.redditmedia.com/uUkSuTDpTWhU4mW5-OXzca_pVR0RQKHkEq-x_eCQC9I.png";
    ...
    >
      ...
      <div className="flex flex-col">
        <a
          ...
          className="text-md font-bold font-mono ml-3 hover:underline hover:underline-offset-2"
          target="_blank"
        >
